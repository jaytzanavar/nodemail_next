...
export default function Content() {
    ...
    return (
        <div className='bg-[url("/lawWallPaper.jpg")] bg-cover h-screen w-screen bg-no-repeat flex'>
            ...
            <div className='w-[50%] bg-black/50 flex flex-col justify-center content-center items-center'>
                <h1 className='font-extrabold text-6xl px-[30%] text-white/90'>{t('prompt')}</h1>
                <h4 className='mb-6 text-lg font-normal text-white/70 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400'>{t('hero')}</h4>
